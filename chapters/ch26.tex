...
Lastly, I have argued that the vagueness of language is an important \emph{natural} source of its normativity,\is{normativity} arising as it does from ``the great variation of things in the world combined with the limitations on our concepts'' as quoted from \citet[21]{murphy:bbc} in \chapref{ch:vagueness}. Thus, this elusive property, too, becomes clear in one of its aspects via understanding the communication of vague utterances.

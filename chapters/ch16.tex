...
Just to amplify my discussion, I will briefly analyze two more examples. The first is a slightly modified example from \citet{grice:lc}.\index{Grice, Paul} One agent asks another where Pierre lives, saying he wants to send him something, and the reply he gets is:
...
The next example is from \citet[page~22]{huglysayward:implicature} who argue convincingly that Grice's own way of handling it was circular. In a conversation about whether Eisenhower\index{Eisenhower, Dwight} was a great US president, one participant offers evidence of Eisenhower's generalship during the war and his great popularity, upon which $\cal A$ says:

...
For greater clarity, I urge the reader to see how the examples we have just discussed, \textit{Bill ran} and \textit{Fed raises interest}, fit into these equations. For example:
\begin{eqnarray*}
{\cal C}_u(\textit{Bill ran}) & = & h_1({\cal C}_u(\textit{Bill}), {\cal C}_u(\textit{ran})) \\
{\cal C}_u(\textit{Bill}) & = & h_4({\cal C}_u(\textit{ran})) \\
{\cal C}_u(\textit{ran}) & = & h_5({\cal C}_u(\textit{Bill}))
\end{eqnarray*}
\noindent and:
\begin{eqnarray*}
{\cal C}_u(\textit{Bill ran}) & = & h_1({\cal C}_u(\textit{Bill}), {\cal C}_u(\textit{ran})) \\
{\cal C}_u(\textit{Bill}) & = & h_6({\cal C}_u(\textit{Bill ran})) \\
{\cal C}_u(\textit{ran}) & = & h_7({\cal C}_u(\textit{Bill ran}))
\end{eqnarray*}

...
%Incidentally, \citet{lewis:c}\index{Lewis, David} who based his signaling games\is{game!signaling} on \citegen{schelling:sc}\index{Schelling, Thomas} normal form games implicitly used imperfect information games, although the informational aspects of such games were never made explicit. Later, they were generalized by game theorists to incomplete information games.
...
Definition~4 and Propositions~2 and 3 allow us to specify the information sets\is{information set} of each agent. They are \emph{information} sets precisely because they have been shown to have the appropriate epistemic properties.

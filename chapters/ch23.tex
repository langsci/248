...
\citet[page~58]{lewis:c}\index{Lewis, David@Lewis, David|(} says there are three basic conditions for a regularity in the behavior of members of a population to be a convention: the regularity itself, a system of mutual expectations, and a system of preferences. On top of this, he demands that these three conditions be common knowledge in the population.
...
\citet{gilbert:gtc} makes some interesting points about the details of Lewis's framework but they are not relevant here as my framework is very different.\index{Lewis, David@Lewis, David|)}

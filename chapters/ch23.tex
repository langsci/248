...
Lewis~\cite[page~58]{lewis:c}\index{Lewis, David|(} says there are three basic conditions for a regularity in the behavior of members of a population to be a convention: the regularity itself, a system of mutual expectations, and a system of preferences. On top of this, he demands that these three conditions be common knowledge in the population.
...
The foregoing addresses some of Burge's~\cite{burge:kc}\index{Burge, Tyler} criticisms of Lewis's notion. First, I replace Lewis's global common knowledge by probabilities and local (generally nonconscious) common knowledge. Second, I consider the issue of switching via a consideration of costs. Burge is also concerned about an over-zealous reliance on rationality in situations where ``inertia, superstition, and ignorance'' may prevail. This observation may be accommodated by using nonconscious partial rationality and awareness (e.g.\ an agent may know only a fragment of the objective partial information game and so may not realize there are other alternative equilibria).

Gilbert~\cite{gilbert:gtc}\index{Gilbert, Margaret} makes some interesting points about the details of Lewis's framework but they are not relevant here as my framework is very different.\index{Lewis, David|)}

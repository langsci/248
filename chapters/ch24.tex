...
The modern English word \textit{dog} derives from the middle English word \textit{dogge} (which comes from the old English word \textit{docga}). Earlier, the word referred to a powerful breed of dogs (such as Great Danes) that originated in England. It was later semantically broadened (and transformed morphologically). This change must have come about through communicative interactions and I now look at the details of the semantic transformation. I abstract from the morphological change and so will use the word \textit{dog} to refer to both its narrower and broader meanings.

...
The problem of comparing the relevance of different inputs is in practice sidestepped by bringing in the idea of accessibility mentioned in the first quote. Based on the ``definition'' of relevance in (1) above, the following comprehension procedure is described in \citet[613]{sw:rt}:

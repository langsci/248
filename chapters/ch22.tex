...
Though the model actually constructed is very simple, it has elements of \citet{peirce:ws},\index{Peirce, C. S.} \citet{saussure:clg, saussure:cgl},\is{de Saussure, F.} and the later \citet{wittgenstein:pi},\index{Wittgenstein, Ludwig} the first because it shows how the connections between words and conventional meanings are arbitrary, the second because it shows they are simultaneous and systemic, and the third because it shows how all meaning arises ultimately from use or communication.
...
\item It fails to show how individual decisions result in a group conventional meaning. Though \citet[page~127]{grice:landc} does say that each member of the group acts in a certain way on the condition that other members do likewise, he does not address how such a circular situation might get off the ground. In a much later publication, \citet[pages~290--297]{grice:mr} constructs a kind of mythical scenario for how nonnatural meaning might emerge from natural meaning. As I wrote in \chapref{ch:Grice}, because he lacked the apparatus of game theory, he could not quite envisage how such nonnatural pairings might arise naturally through rational choice although they may build on quasi-natural gestural pairings.
...
He also focuses exclusively on pure coordination. As Gintis\index{Gintis, Herbert} points out in his review of Skyrms's book:\footnote{\url{https://www.amazon.com/gp/customer-reviews/R1TCQS6NFB5M3K/}}

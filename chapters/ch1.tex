...
Informal game-theoretic thinking is quite old, going back to classical times in multiple cultures. Possibly its modern roots can be traced to Machiavelli\index{Machiavelli, Niccolo} and Hobbes.\index{Hobbes, Thomas} Its first formal results were obtained by \citet{zermelo:chess} in connection with the game of chess. As \citet[page 1]{myerson:gt} says, \emph{interactive decision theory} might have been a more descriptively accurate name for the theory as it allows one to consider practical and epistemic interactions between people in a computationally tractable way.

...
Consider now an utterance by $\cal A$ to $\cal B$ in $u$ of the sentence $\varphi = \Expression{Bill is very bald}$. Then the two maps above will apply to each of the four words in the utterance. As our interest is in \Expression{bald}, we get the picture:\label{page:vague communication}
